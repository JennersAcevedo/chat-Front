...
// ---> API Configuration 
// Change this URL to your external API URL
...
export class ChatApiService {
  ...
  /**
   * Sends a message to chat and gets the response
   * @param message - The user message
   * @returns Promise with bot response
   * @throws ApiError if there is an error in the request
   */
    ...
    try {
      ...
      if (!response.ok) {
        ...
        try {
          ...
          // If API returns specific error message, use it
